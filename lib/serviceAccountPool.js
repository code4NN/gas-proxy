...
/**
 * Returns a cached JWT auth client for the next account in rotation.
 */
// export function getNextAuth() {
//     const index = current;
//     current = (current + 1) % accountCreds.length;

//     // 🧠 Return cached JWT client if already created
//     if (jwtClients[index]) {
//         console.log("Returning sheet-connection from cache")
//         return jwtClients[index];
//     }
//     console.log("Returning Fresh sheet-connection")
